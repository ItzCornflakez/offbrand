...
let UserController = class UserController {
    ...
    async createUserDetails(userDetailsData) {
...
__decorate([
    (0, common_1.Post)('user/:id/details'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "createUserDetails", null);
__decorate([
    (0, common_1.Post)('user/:id/password'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "createPassword", null);
__decorate([
...
__decorate([
    (0, common_1.Delete)('user/:id/details'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "deleteUserDetails", null);
__decorate([
    (0, common_1.Delete)('user/:id/password'),
    __param(0, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
