import { Body, Controller, Get, HttpStatus, Param, ParseIntPipe, Patch, Post, Put, Query, Version } from '@nestjs/common';
...
export class DiscountController {
    ...
    @Post()
    @Version('1')
    async createNewDiscount(@Body() newDiscountDto: CreateNewDiscountDto): Promise<DefaultResponseDto>{
    ...
    @Get()
    @Version('1')
    async getAllDiscounts(@Query() getAllDiscountsQueryParamsDto: GetAllDiscountsQueryParamsDto): Promise<DefaultResponseDto>{
    ...
    @Get(':id')
    @Version('1')
    async getDiscountById(@Param('id', ParseIntPipe) discountId: number): Promise<DefaultResponseDto>{
    ...
    @Get('/active')
    @Version('1')
    async getAllActiveDiscounts(@Query() getDiscountQueryParamsDto: GetDiscountsQueryParamsDto): Promise<DefaultResponseDto>{
    ...
    @Get('/inactive')
    @Version('1')
    async getAllInactiveDiscounts(@Query() getDiscountQueryParamsDto: GetDiscountsQueryParamsDto){
    ...
    @Get('/deleted')
    @Version('1')
    async getAllDeletedDiscounts(@Query() getDiscountQueryParamsDto: GetDiscountsQueryParamsDto): Promise<DefaultResponseDto>{
    ...
    @Put(':id')
    @Version('1')
    async updateDiscountById(@Param('id', ParseIntPipe) discountId: number, @Body() editDiscountDto: EditDiscountDto): Promise<DefaultResponseDto>{
    ...
    @Patch(':id/delete')
    @Version('1')
    async deleteDiscountById(@Param('id', ParseIntPipe) discountId: number): Promise<DefaultResponseDto>{
    ...
    @Patch(':id/restore')
    @Version('1')
    async restoreDiscountById(@Param('id', ParseIntPipe) discountId: number): Promise<DefaultResponseDto>{
    ...
    @Patch(':id/activate')
    @Version('1')
    async activateDiscountById(@Param('id', ParseIntPipe) discountId: number): Promise<DefaultResponseDto>{
    ...
    @Patch(':id/inactivate')
    @Version('1')
    async inactivateDiscountById(@Param('id', ParseIntPipe) discountId: number): Promise<DefaultResponseDto>{
