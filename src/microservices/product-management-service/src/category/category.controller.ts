import {Body, Controller, Get, HttpStatus, Param, ParseIntPipe, Post, Put, Patch, Version, Query } from '@nestjs/common';
...
export class CategoryController {
  ...
  @Get()
  @Version('1')
  async getAllCategories(@Query() allCategoriesQueryParamsDto: GetAllCategoriesQueryParamsDto): Promise<DefaultResponseDto> {
  ...
  @Get(':id')
  @Version('1')
  async getCategoryById(@Param('id', ParseIntPipe) categoryId: number): Promise<DefaultResponseDto>{
  ...
  @Get('/deleted')
  @Version('1')
  async getAllDeletedCategories(@Query() allDeletedCategoriesQueryParamsDto: GetAllDeletedCategoriesQueryParamsDto): Promise<DefaultResponseDto>{
  ...
  @Put(':id')
  @Version('1')
  async updateCategoryById(@Param('id', ParseIntPipe) categoryId: number, @Body() editCategoryDto: EditCategoryDto): Promise<DefaultResponseDto>{
  ...
  @Patch(':id/delete')
  @Version('1')
  async deleteCategoryById(@Param('id', ParseIntPipe) categoryId: number): Promise<DefaultResponseDto>{
  ...
  @Patch(':id/restore')
  @Version('1')
  async restoreDeletedCategoryById(@Param('id', ParseIntPipe) categoryId: number): Promise<DefaultResponseDto>{
